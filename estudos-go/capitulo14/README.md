# 📖 Capítulo 14: Título do Capítulo
...
### 1. [Exemplo 01: Nome](file:///c:/Users/jorge/OneDrive/Documentos/PROJECTS/go-in-practice-book/estudos-go/capitulo14/exemplos/exe01/main.go)
*   **Conceito:** descrição.
...
### 1. [Exercício 01: Nome](file:///c:/Users/jorge/OneDrive/Documentos/PROJECTS/go-in-practice-book/estudos-go/capitulo14/exercicios/exe01/main.go)
...
- [ ] Todos os exemplos do capítulo têm pasta própria em `exemplos/exe01`, `exe02`... (dois dígitos)
- [ ] Todos os exercícios resolvidos têm pasta própria em `exercicios/exe01`, `exe02`... (dois dígitos)
...
- [ ] Artigo de Medium criado em `conteudo/medium/capitulo14.md` (a partir do `_template.md`, baseado no `fonte.txt`)
- [ ] Post de LinkedIn criado em `conteudo/linkedin/capitulo14.md` (a partir do `_template.md`, baseado no `fonte.txt`)
- [ ] Status atualizado em `conteudo/PAINEL.md`
- [ ] Pilha de exercícios extras (mín. 10, dificuldade crescente) criada em `pilha-exercicios/capitulo14.md`
- [ ] Teste de mesa de todo o código do capítulo criado em `teste-de-mesa.md`
- [ ] Fonte NotebookLM criada em `notebooklm/capitulo14.md`
